export class DeleteTypeDialogPage {
	...
	get instancesCheckbox(): HTMLInputElement | null { return this.root.querySelector<HTMLInputElement>('[data-testid="delete-type-instances-checkbox"]'); }
	get instancesCheckboxLabel(): HTMLElement | null { return this.el('delete-type-instances-checkbox-label'); }
