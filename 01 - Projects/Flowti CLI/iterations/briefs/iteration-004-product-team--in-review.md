...
# Agent Brief: Product Team — Iteration #4
...
To advance from **in-review** to the next phase:
...
Update the iteration plan ([[iteration-004-plan|Iteration #4 Plan]]) directly:
- Mark completed items as `- [x]`
- Add new items as `- [ ]`
- Add notes under `## Notes`

## Assigned Tasks
- [x] Coordinate team review
