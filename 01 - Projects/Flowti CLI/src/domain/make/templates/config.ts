/**
 * config.ts — Shared config-file template generators.
 *
 * Pure functions that produce manifest.json, package.json, tsconfig.json,
 * esbuild.config.mjs, vitest.config.ts, and .gitignore content strings.
 */
