...
export const ENTITY_REGISTRY: EntityDef[] = [
	...
	{
		name: "Requirement",
		description: "An IREB-compliant requirement (functional, non-functional, or constraint) with MoSCoW priority, traceability links, and acceptance criteria.",
		purpose: "Requirements engineering. Define and track project requirements with IREB compliance, linking to use cases and user stories for full traceability.",
		locations: [
			...
			"src/ui/menus/requirements-menu.ts — interactive menu",
		],
	...
	{
		name: "Use Case",
		description: "An actor-goal scenario describing a system interaction with preconditions, postconditions, and main/alternative flows.",
		purpose: "Behavioral specification. Document how actors interact with the system, linked to requirements for traceability.",
		locations: [
			"src/domain/requirements/requirement-store.ts — CRUD operations",
		],
		configKey: "management.requirements",
	...
	},
	{
		...
		purpose: "Agile backlog management. Capture user needs as stories with acceptance criteria, linked to formal requirements.",
		locations: [
			"src/domain/requirements/requirement-store.ts — CRUD operations",
		],
		configKey: "management.requirements",
	...
	{
		name: "CAPA Item",
		description: "A corrective or preventive action tracked through a full CAPA lifecycle — from identification through root cause analysis, action planning, implementation, verification, and closure.",
		purpose: "Quality management. Track corrective and preventive actions with severity, source, root cause analysis, and verification criteria following CAPA methodology.",
		locations: [
			"src/domain/capa/capa-store.ts — CRUD operations",
			"src/domain/capa/capa-types.ts — type definitions",
			"src/ui/menus/capa-menu.ts — interactive menu",
		],
	...
	},
	{
		...
		description: "A user-defined markdown template that customizes frontmatter properties and body content for CLI-generated entities.",
		purpose: "Template customization. Users define default properties and content for each entity type; user values take precedence over CLI defaults.",
		locations: [
			"src/domain/templates/entity-template.ts — loading and merging",
			"docs/templates/ — per-entity-type template files",
		],
		configKey: "templates",
