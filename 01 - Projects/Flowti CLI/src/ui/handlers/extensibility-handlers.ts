/** extensibility-handlers.ts — Action handlers for agents menus. */
...
import { RESET, DIM, GREEN, BOLD } from "../../infrastructure/ui.js";
...
import { syncAgentsToClaude } from "../../domain/claude-sync/claude-sync.js";
import { registerPluginAndAiToolHandlers } from "./plugin-ai-tool-handlers.js";
...
export function registerExtensibilityHandlers(registry: HandlerRegistry): void {
	registerPluginAndAiToolHandlers(registry);
