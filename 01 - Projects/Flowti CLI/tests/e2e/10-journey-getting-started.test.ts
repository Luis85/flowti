...
// Run via: npm run test:e2e -- --journey=getting-started
//
// To execute manually:
//   1. Start Obsidian with the test vault
//   2. npx vitest run tests/e2e/<this-file> --config configs/vitest.config.ts
//
// The journey definition is loaded from: tests/e2e/journeys/getting-started.journey

describe.skip("Journey: getting-started", () => {
	it("executes the getting-started journey", () => {
