...
import { renderComponentAdding } from "../../src/ui/make-renderers.js";
...
describe("renderComponentAdding", () => {
	it("renders definition label and component name", () => {
		renderComponentAdding("Component", "Button");
		const out = output();
