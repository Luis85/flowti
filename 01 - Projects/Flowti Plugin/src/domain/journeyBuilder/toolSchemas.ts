...
export const TOOL_SCHEMAS: Record<JourneyToolName, ToolSchemaDef> = {
	...
	assert: {
		...
		fields: [
			...
			{ key: "selector", label: "CSS Selector", type: "text", placeholder: "For visible/not-visible/text/count/attr", visibleWhen: { field: "type", values: ["visible", "not-visible", "text", "count", "attr"] } },
			{ key: "contains", label: "Contains", type: "text", placeholder: "Expected text content", visibleWhen: { field: "type", values: ["text"] } },
			{ key: "event", label: "Event Name", type: "text", placeholder: "For event assertion", visibleWhen: { field: "type", values: ["event"] } },
			{ key: "viewType", label: "View Type", type: "text", placeholder: "For leaf assertion", visibleWhen: { field: "type", values: ["leaf"] } },
			{ key: "code", label: "Code", type: "textarea", placeholder: "JavaScript for eval assertion", visibleWhen: { field: "type", values: ["eval"] } },
			{ key: "expected", label: "Expected", type: "text", placeholder: "Expected eval result", visibleWhen: { field: "type", values: ["eval"] } },
			{ key: "count", label: "Count", type: "number", placeholder: "Expected element count", visibleWhen: { field: "type", values: ["count"] } },
			{ key: "attr", label: "Attribute", type: "text", placeholder: "Attribute name", visibleWhen: { field: "type", values: ["attr"] } },
			{ key: "value", label: "Value", type: "text", placeholder: "Expected attribute value", visibleWhen: { field: "type", values: ["attr"] } },
		],
	},
	"assert-text": {
		name: "assert-text",
