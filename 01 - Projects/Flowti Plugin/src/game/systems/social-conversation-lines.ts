/**
 * social-conversation-lines.ts — Domain-specific conversation lines for proximity chatter.
 *
 * Extracted from social-system.ts to reduce file size. Each domain has
 * a pool of one-liner conversation fragments used when agents chat.
 */

export const CONVERSATION_LINES: Record<string, readonly string[]> = {
	engineering: [
