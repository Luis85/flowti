...
import { resetStyles } from "./game-styles.js";
import type { DashboardStore } from "../store/dashboard-store.js";

export class DashboardOverlays extends FlowtiElement {
	static properties = {
...
if (!customElements.get("ft-game-overlays")) customElements.define("ft-game-overlays", DashboardOverlays);
