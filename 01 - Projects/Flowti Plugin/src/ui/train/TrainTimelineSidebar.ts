...
import { computeGraphLayout, LANE_COLORS, LANE_WIDTH } from "../../domain/train/graph-layout";
import type { GraphRow } from "../../domain/train/graph-layout";

// Re-export for backward compat
export { VIEW_TYPE_TRAIN_TIMELINE } from "./types";
export { computeGraphLayout, LANE_COLORS, LANE_WIDTH } from "../../domain/train/graph-layout";
export type { GraphRow } from "../../domain/train/graph-layout";
