...
describe("engine-config", () => {
	...
	describe("object positions", () => {
		it("has 11 environmental objects", () => {
			expect(Object.keys(OBJECT_POSITIONS)).toHaveLength(11);
		});
	...
	describe("timing constants", () => {
		...
		it("all millisecond delays are positive integers", () => {
			...
			expect(PET_REACTION_COOLDOWN).toBeGreaterThan(0);
			expect(Number.isInteger(PET_REACTION_COOLDOWN)).toBe(true);
