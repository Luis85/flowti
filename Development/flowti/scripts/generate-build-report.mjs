 ...
 * Source: 01 - Projects/Flowti CLI/scripts/generate-build-report.mjs
 */
...
const SCRIPT = path.join(VAULT_ROOT, "01 - Projects", "Flowti CLI", "scripts", "generate-build-report.mjs");
