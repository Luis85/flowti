 ...
 * Source: 01 - Projects/Flowti CLI/scripts/generate-tool-reference.mjs
 */
...
const SCRIPT = path.join(VAULT_ROOT, "01 - Projects", "Flowti CLI", "scripts", "generate-tool-reference.mjs");
