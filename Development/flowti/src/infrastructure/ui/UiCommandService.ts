...
import { VIEW_TYPE_EVENT_CATALOG, VIEW_TYPE_TRAIN_HUB, VIEW_TYPE_ANALYTICS_HUB, VIEW_TYPE_TEST_MANAGEMENT_HUB, VIEW_TYPE_DATA_EXCHANGE_HUB } from "../../domain/hub/types";
